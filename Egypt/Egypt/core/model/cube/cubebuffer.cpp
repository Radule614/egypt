...
std::vector<Core::Vertex> Core::CubeBuffer::m_Vertices = {
...
Core::CubeBuffer::CubeBuffer() {
    CalculateTangent(m_Vertices);
}

std::vector<Core::Vertex> Core::CubeBuffer::GetVertices() {
	return m_Vertices;
}

unsigned Core::CubeBuffer::GetVertexCount() {
